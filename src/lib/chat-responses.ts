export const simpleResponses: { [key: string]: string } = {
  // Greetings
  ...
  "what u can do": "I can manage your tasks, track your expenses, set reminders, and help with your goals. Just tell me what you need!",
